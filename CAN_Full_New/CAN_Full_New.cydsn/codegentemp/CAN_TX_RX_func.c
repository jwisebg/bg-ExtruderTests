...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgtxex1
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgtxex1(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_txex1_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_txex1_CALLBACK
                    CAN_SendMsg_txex1_Callback();
                #endif /* CAN_SEND_MSG_txex1_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgtxex2
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgtxex2(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_txex2_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_txex2_CALLBACK
                    CAN_SendMsg_txex2_Callback();
                #endif /* CAN_SEND_MSG_txex2_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgtxex3
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgtxex3(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_txex3_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_txex3_CALLBACK
                    CAN_SendMsg_txex3_Callback();
                #endif /* CAN_SEND_MSG_txex3_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgtxex4
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgtxex4(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_txex4_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_txex4_CALLBACK
                    CAN_SendMsg_txex4_Callback();
                #endif /* CAN_SEND_MSG_txex4_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgtxex5
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgtxex5(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_txex5_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_txex5_CALLBACK
                    CAN_SendMsg_txex5_Callback();
                #endif /* CAN_SEND_MSG_txex5_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgtxex6
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgtxex6(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_txex6_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_txex6_CALLBACK
                    CAN_SendMsg_txex6_Callback();
                #endif /* CAN_SEND_MSG_txex6_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgtxstep
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgtxstep(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_txstep_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_txstep_CALLBACK
                    CAN_SendMsg_txstep_Callback();
                #endif /* CAN_SEND_MSG_txstep_CALLBACK */
...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvex1
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvex1(void) 
    {
        /* `#START MESSAGE_recvex1_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvex1_CALLBACK
            CAN_ReceiveMsg_recvex1_Callback();
        #endif /* CAN_RECEIVE_MSG_recvex1_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_ReceiveMsgrecvex2
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvex2(void) 
    {
        /* `#START MESSAGE_recvex2_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvex2_CALLBACK
            CAN_ReceiveMsg_recvex2_Callback();
        #endif /* CAN_RECEIVE_MSG_recvex2_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvex3
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvex3(void) 
    {
        /* `#START MESSAGE_recvex3_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvex3_CALLBACK
            CAN_ReceiveMsg_recvex3_Callback();
        #endif /* CAN_RECEIVE_MSG_recvex3_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvex4
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvex4(void) 
    {
        /* `#START MESSAGE_recvex4_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvex4_CALLBACK
            CAN_ReceiveMsg_recvex4_Callback();
        #endif /* CAN_RECEIVE_MSG_recvex4_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvex5
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvex5(void) 
    {
        /* `#START MESSAGE_recvex5_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvex5_CALLBACK
            CAN_ReceiveMsg_recvex5_Callback();
        #endif /* CAN_RECEIVE_MSG_recvex5_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvex6
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvex6(void) 
    {
        /* `#START MESSAGE_recvex6_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvex6_CALLBACK
            CAN_ReceiveMsg_recvex6_Callback();
        #endif /* CAN_RECEIVE_MSG_recvex6_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvstepx
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvstepx(void) 
    {
        /* `#START MESSAGE_recvstepx_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvstepx_CALLBACK
            CAN_ReceiveMsg_recvstepx_Callback();
        #endif /* CAN_RECEIVE_MSG_recvstepx_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvstepy1
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvstepy1(void) 
    {
        /* `#START MESSAGE_recvstepy1_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvstepy1_CALLBACK
            CAN_ReceiveMsg_recvstepy1_Callback();
        #endif /* CAN_RECEIVE_MSG_recvstepy1_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvstepy2
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvstepy2(void) 
    {
        /* `#START MESSAGE_recvstepy2_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvstepy2_CALLBACK
            CAN_ReceiveMsg_recvstepy2_Callback();
        #endif /* CAN_RECEIVE_MSG_recvstepy2_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgrecvstepz
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgrecvstepz(void) 
    {
        /* `#START MESSAGE_recvstepz_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_recvstepz_CALLBACK
            CAN_ReceiveMsg_recvstepz_Callback();
        #endif /* CAN_RECEIVE_MSG_recvstepz_CALLBACK */

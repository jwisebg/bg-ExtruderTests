...
#define CAN_RX_MAILBOX_TYPE            (0x3FFu)
#define CAN_TX_MAILBOX_TYPE            (0x7Fu)
...
#define CAN_TX_MAILBOX_txex1           (0u)
#define CAN_TX_MAILBOX_txex2           (1u)
#define CAN_TX_MAILBOX_txex3           (2u)
#define CAN_TX_MAILBOX_txex4           (3u)
#define CAN_TX_MAILBOX_txex5           (4u)
#define CAN_TX_MAILBOX_txex6           (5u)
#define CAN_TX_MAILBOX_txstep          (6u)
#define CAN_TX_MAILBOX_7               (7u)

/* RX Defines to link mailbox names with mailbox numbers */
#define CAN_RX_MAILBOX_recvex1         (0u)
#define CAN_RX_MAILBOX_recvex2         (1u)
#define CAN_RX_MAILBOX_recvex3         (2u)
#define CAN_RX_MAILBOX_recvex4         (3u)
#define CAN_RX_MAILBOX_recvex5         (4u)
#define CAN_RX_MAILBOX_recvex6         (5u)
#define CAN_RX_MAILBOX_recvstepx       (6u)
#define CAN_RX_MAILBOX_recvstepy1      (7u)
#define CAN_RX_MAILBOX_recvstepy2      (8u)
#define CAN_RX_MAILBOX_recvstepz       (9u)
